...
/**
	...
	public BoardVector getBoardVector(StateObservation so) {
		...
		if (this.getNumPositionValues()==4) {
			...
			for (ACTIONS availAct : availActs) {
				retVal[availAct.toInt()] = 3;
			}
		}
	 ...
	 * 
	 * @param boardVector the original board vector
	 * @return the vector of symmetric {@link BoardVector}s
	 */
	@Override
	 ...
	 * </pre>
	 * @param boardVector the original board vector
	 * @return the rotated board vector
	 */
